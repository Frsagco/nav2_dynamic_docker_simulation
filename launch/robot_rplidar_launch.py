...
def get_ros2_nodes(*args):
    ...
    robot_description = pathlib.Path(os.path.join(package_dir, 'resource', 'turtlebot_rplidar.urdf')).read_text()
    ...
    mappings = [('/diffdrive_controller/cmd_vel_unstamped', '/cmd_vel'),
                ('/TurtleBot3Burger/RPlidar_A2', '/scan')]
    ...
    rplidar_publisher = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        output='screen',
        arguments=['0', '0', '0', '0', '0', '0', 'base_link', 'RPlidar_A2'],
    )
